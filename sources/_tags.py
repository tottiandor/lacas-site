...
TOPICS: dict[str, list[str]] = {
    ...
    "Media": ["media", "publisher", "newspaper", "broadcast", "journalism", "sajto",
              "ujsagiro", "mediapiac"],
    "Retail": ["retail", "supermarket", "shopper", "shoppable", "storefront",
               "ecommerce", "e-commerce", "amazon", "kiskereskedelem", "bolt", "webshop"],
    "Strategy": ["strateg", "planner", "brand strategy", "insight", "strategia"],
    "Diversity": ["diversity", "inclusion", "neurodiver", "adhd", "dei", "accessib",
                  "sokszinuseg", "befogadas"],
